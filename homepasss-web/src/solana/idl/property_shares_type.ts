// CHANGE: Copied the generated Anchor TypeScript IDL so the frontend can compile strongly typed program clients.
// WHY: Without the IDL the Anchor `Program<PropertyShares>` calls (buy/deposit/claim) cannot be type-checked.
// QUOTE(TЗ): "Надо сделать что бы мы всё минтили"
// REF: user-message-61
// SOURCE: /home/user/holding_contracts_solana_hackathon/app/src/idl/property_shares_type.ts
